...
In this work we have used Convolutional neural network for classifying emotions. Generally, spectrograms are given as input to the CNN. Spectrogram is a time-frequency representation of a signal. 
